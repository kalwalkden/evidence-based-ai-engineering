...
Use one Claude project per codebase. Copy the [experiment prompts](HEADLESS_PROMPTS.md) into that project,
...
Use the setup and execution prompts in [PROMPTS.md](HEADLESS_PROMPTS.md). Keep the normal Claude
